...
{
	[Conditional("DEVELOPMENT_BUILD"), Conditional("UNITY_EDITOR"), Conditional("UNITY_ASSERTIONS"), Conditional("ENABLE_LOGS")]
	...
	[Conditional("DEVELOPMENT_BUILD"), Conditional("UNITY_EDITOR"), Conditional("ENABLE_LOGS")]
